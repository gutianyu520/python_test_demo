...
class WSGIServer:
    ...
    def handleReq(self):
        self.recvdata = self.cli.recv(2014)
        lines = self.recvdata.splitlines()
        for line in lines:
    ...
    def parseRequest(self):
        respLine = self.recvdata.splitlines()[0]
        respLine = str(respLine,'utf-8').rstrip('\r\n')
        self.requestMethod,self.path,self.requestVersion = respLine.split(' ')
